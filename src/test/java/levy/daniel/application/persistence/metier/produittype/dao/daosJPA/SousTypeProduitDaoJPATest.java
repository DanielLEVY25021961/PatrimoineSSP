 ...
 * CLASSE SousTypeProduitDaoJPATest.java :
 * </p>
 *
 * <p>
 * Test JUnit didactique direct du DAO Spring Data JPA
 * {@link SousTypeProduitDaoJPA}.
 * </p>
 *
 * <p>Ce test ne passe volontairement par aucun Gateway.</p>
 * <ul>
 * <li>Il injecte directement le repository {@link SousTypeProduitDaoJPA}.</li>
 ...
 * <li>montrer que, pour {@link SousTypeProduitJPA}, le libellé seul
 * n'est pas la clé métier complète : le parent {@link TypeProduitJPA}
 * fait partie du graphe à contrôler ;</li>
...
@Sql(
    scripts = {
            SousTypeProduitDaoJPATest.CLASSPATH_TRUNCATE_SQL,
            SousTypeProduitDaoJPATest.CLASSPATH_DATA_SQL
    },
    executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD
)
@DataJpaTest
@ActiveProfiles({ "test-jpa" })
@ContextConfiguration(classes = SousTypeProduitDaoJPATest.ConfigTest.class)
public class SousTypeProduitDaoJPATest {
    ...
    /** "SousTypeProduitDaoJPA" */
    public static final String QUALIFIER_DAO
        = "SousTypeProduitDaoJPA";

    /** "dao-SousTypeProduit" */
    public static final String TAG_DAO_SOUS_TYPE_PRODUIT
        = "dao-SousTypeProduit";
    ...
    /** "findBySousTypeProduitIgnoreCase(OK) - retrouve le libellé exact sans tenir compte de la casse" */
    public static final String DN_FIND_BY_SOUS_TYPE_PRODUIT_IGNORE_CASE_OK
        = "findBySousTypeProduitIgnoreCase(OK) - retrouve le libellé exact sans tenir compte de la casse";

    /** "findBySousTypeProduitIgnoreCase(non trouvé) - retourne une liste vide non null" */
    public static final String DN_FIND_BY_SOUS_TYPE_PRODUIT_IGNORE_CASE_NON_TROUVE
        = "findBySousTypeProduitIgnoreCase(non trouvé) - retourne une liste vide non null";

    /** "findBySousTypeProduitContainingIgnoreCase(OK) - retrouve les libellés contenant le motif sans tenir compte de la casse" */
    public static final String DN_FIND_BY_SOUS_TYPE_PRODUIT_CONTAINING_IGNORE_CASE_OK
        = "findBySousTypeProduitContainingIgnoreCase(OK) - retrouve les libellés contenant le motif sans tenir compte de la casse";

    /** "findBySousTypeProduitContainingIgnoreCase(non trouvé) - retourne une liste vide non null" */
    public static final String DN_FIND_BY_SOUS_TYPE_PRODUIT_CONTAINING_IGNORE_CASE_NON_TROUVE
        = "findBySousTypeProduitContainingIgnoreCase(non trouvé) - retourne une liste vide non null";

    /** "findAllByTypeProduit(OK) - retrouve les objets rattachés au parent demandé" */
	public static final String DN_FIND_ALL_BY_TYPE_PRODUIT_OK
	    = "findAllByTypeProduit(OK) - retrouve les objets rattachés au parent demandé";

	/** "findAllByTypeProduit(parent sans enfant) - retourne une liste vide non null" */
	public static final String DN_FIND_ALL_BY_TYPE_PRODUIT_PARENT_SANS_ENFANT
	    = "findAllByTypeProduit(parent sans enfant) - retourne une liste vide non null";
    ...
    public static final String SELECT_COUNT_FROM_SOUS_TYPES_PRODUIT_WHERE_LIBELLE
        = "SELECT COUNT(*) FROM SOUS_TYPES_PRODUIT WHERE UPPER(SOUS_TYPE_PRODUIT) = UPPER(?)";

    /** "SELECT COUNT(*) FROM SOUS_TYPES_PRODUIT WHERE UPPER(SOUS_TYPE_PRODUIT) LIKE UPPER(?)" */
    public static final String SELECT_COUNT_FROM_SOUS_TYPES_PRODUIT_WHERE_LIKE
        = "SELECT COUNT(*) FROM SOUS_TYPES_PRODUIT WHERE UPPER(SOUS_TYPE_PRODUIT) LIKE UPPER(?)";

    /**
     * "SELECT STP.ID_SOUS_TYPE_PRODUIT AS ID_SOUS_TYPE_PRODUIT,
     ...
     * JOIN TYPES_PRODUIT TP ON TP.ID_TYPE_PRODUIT = STP.TYPE_PRODUIT
     * WHERE UPPER(STP.SOUS_TYPE_PRODUIT) = UPPER(?)"
     */
    public static final String SELECT_SOUS_TYPES_AVEC_PARENT_WHERE_LIBELLE
        = """
          SELECT
          ...
          JOIN TYPES_PRODUIT TP
              ON TP.ID_TYPE_PRODUIT = STP.TYPE_PRODUIT
          WHERE UPPER(STP.SOUS_TYPE_PRODUIT) = UPPER(?)
          """;
     ...
     */
    public static final String SELECT_SOUS_TYPES_AVEC_PARENT_WHERE_LIKE
        = """
          SELECT
              STP.ID_SOUS_TYPE_PRODUIT AS ID_SOUS_TYPE_PRODUIT,
              STP.SOUS_TYPE_PRODUIT AS SOUS_TYPE_PRODUIT,
	...
	public static final String SELECT_COUNT_FROM_SOUS_TYPES_PRODUIT_WHERE_PARENT
	    = "SELECT COUNT(*) FROM SOUS_TYPES_PRODUIT WHERE TYPE_PRODUIT = ?";
	 ...
	 * FROM SOUS_TYPES_PRODUIT STP
	 * JOIN TYPES_PRODUIT TP ON TP.ID_TYPE_PRODUIT = STP.TYPE_PRODUIT
	 * WHERE TP.ID_TYPE_PRODUIT = ?"
	 */
	public static final String SELECT_SOUS_TYPES_AVEC_PARENT_WHERE_PARENT
	    = """
	      SELECT
	          STP.ID_SOUS_TYPE_PRODUIT AS ID_SOUS_TYPE_PRODUIT,
	          STP.SOUS_TYPE_PRODUIT AS SOUS_TYPE_PRODUIT,
     ...
     * <code>SousTypeProduitGatewayJPAService</code>, afin de vérifier
     ...
     * </div>
     */
    public SousTypeProduitDaoJPATest() {
        super();
    }
     ...
     * <div>
     * <p>garantit que
     * {@link SousTypeProduitDaoJPA#findBySousTypeProduitIgnoreCase(String)}
     ...
     * <li>retourne l'objet métier avec son parent {@link TypeProduitJPA} ;</li>
     ...
     * @throws Exception
     */
    @Tag(TAG_DAO_SOUS_TYPE_PRODUIT)
    @DisplayName(DN_FIND_BY_SOUS_TYPE_PRODUIT_IGNORE_CASE_OK)
    @Test
    public void testFindBySousTypeProduitIgnoreCaseTrouve() throws Exception {
        ...
        final Long countLibelle = this.jdbcTemplate.queryForObject(
                SELECT_COUNT_FROM_SOUS_TYPES_PRODUIT_WHERE_LIBELLE,
                Long.class,
                VETEMENT_HOMME);
        ...
        /*
         * Relit par SQL direct la ligne attendue avec son parent TypeProduit.
         *
        ...
        final List<Map<String, Object>> lignesStockage =
                this.jdbcTemplate.queryForList(
                        SELECT_SOUS_TYPES_AVEC_PARENT_WHERE_LIBELLE,
                        VETEMENT_HOMME);
         ...
         *
         * Le libellé seedé est "vêtement pour homme".
        ...
        final String libelleRecherche =
                VETEMENT_HOMME.toUpperCase(LOCALE_ROOT);

        /* ACT :
         * appelle directement le DAO, sans passer par le Gateway.
         */
        final List<SousTypeProduitJPA> resultats =
                this.sousTypeProduitDaoJPA.findBySousTypeProduitIgnoreCase(
                        libelleRecherche);
        ...
        final SousTypeProduitJPA resultat = resultats.get(0);
         ...
         * - même parent TypeProduit.
         */
        assertThat(resultat.getIdSousTypeProduit())
        ...
        assertThat(resultat.getTypeProduit().getIdTypeProduit())
            .isEqualTo(Long.valueOf(
     ...
     */
    @Tag(TAG_DAO_SOUS_TYPE_PRODUIT)
    @DisplayName(DN_FIND_BY_SOUS_TYPE_PRODUIT_IGNORE_CASE_NON_TROUVE)
    @Test
    public void testFindBySousTypeProduitIgnoreCaseNonTrouve()
            throws Exception {
     ...
     * <div>
     * <p>garantit que
     * {@link SousTypeProduitDaoJPA#findBySousTypeProduitContainingIgnoreCase(String)}
     ...
     * <li>retourne les objets métier avec leur parent {@link TypeProduitJPA} ;</li>
     * <li>n'altère pas le stockage.</li>
     * </ul>
     * </div>
     *
     ...
     */
    @Tag(TAG_DAO_SOUS_TYPE_PRODUIT)
    @DisplayName(DN_FIND_BY_SOUS_TYPE_PRODUIT_CONTAINING_IGNORE_CASE_OK)
    @Test
    public void testFindBySousTypeProduitContainingIgnoreCaseTrouve()
            throws Exception {
        ...
        final Long countMotif = this.jdbcTemplate.queryForObject(
                SELECT_COUNT_FROM_SOUS_TYPES_PRODUIT_WHERE_LIKE,
                Long.class,
                "%" + CONTENU_PARTIEL_VET + "%");
        ...
        final List<Map<String, Object>> lignesStockage =
                this.jdbcTemplate.queryForList(
                        SELECT_SOUS_TYPES_AVEC_PARENT_WHERE_LIKE,
                        "%" + CONTENU_PARTIEL_VET + "%");
        ...
        /*
         * Extrait les clés parent + libellé depuis la référence SQL.
         *
         * Pour SousTypeProduit, on ne raisonne pas seulement sur le libellé :
         * le parent TypeProduit est aussi contrôlé.
         */
        final List<String> clesStockage = lignesStockage.stream()
                .map(ligne -> ligne.get(TYPE_PRODUIT)
                        + "||"
                        + ligne.get(SOUS_TYPE_PRODUIT))
                .toList();

        /*
         * Prépare le motif avec une casse différente.
         *
         * Le contenu seedé contient le motif "vêt".
        ...
        final String contenuRecherche =
                CONTENU_PARTIEL_VET.toUpperCase(LOCALE_ROOT);
         ...
         * le DAO retourne des entities SousTypeProduitJPA,
         * et l'objet métier intermédiaire doit rester rattaché
         * à son parent TypeProduit.
         */
        assertThat(resultats).allSatisfy(resultat -> {
            assertThat(resultat.getSousTypeProduit()).isNotBlank();
            assertThat(resultat.getTypeProduit()).isNotNull();
            assertThat(resultat.getTypeProduit().getTypeProduit()).isNotBlank();
        });

        /*
         * Extrait les clés parent + libellé retournées par le DAO.
         */
        final List<String> clesResultats = resultats.stream()
                .map(resultat -> resultat.getTypeProduit().getTypeProduit()
                        + "||"
                        + resultat.getSousTypeProduit())
                .toList();
        ...
        assertThat(resultats)
            .extracting(SousTypeProduitJPA::getSousTypeProduit)
            .allSatisfy(libelle -> assertThat(libelle)
                    .isNotNull()
                    .containsIgnoringCase(CONTENU_PARTIEL_VET));
        ...
        assertThat(resultats)
            .extracting(SousTypeProduitJPA::getSousTypeProduit)
            .contains(VETEMENT_HOMME, VETEMENT_FEMME, VETEMENT_ENFANT);
     ...
     */
    @Tag(TAG_DAO_SOUS_TYPE_PRODUIT)
    @DisplayName(DN_FIND_BY_SOUS_TYPE_PRODUIT_CONTAINING_IGNORE_CASE_NON_TROUVE)
    @Test
    public void testFindBySousTypeProduitContainingIgnoreCaseNonTrouve()
            throws Exception {
     ...
     * <div>
     * <p>garantit que
     * {@link SousTypeProduitDaoJPA#findAllByTypeProduit(TypeProduitJPA)}
     * avec un parent existant portant des enfants :</p>
     * <ul>
     * <li>retourne une liste non null et non vide ;</li>
     * <li>retourne les objets rattachés au parent {@link TypeProduitJPA}
     * demandé ;</li>
     * <li>retourne le même ensemble que la requête SQL de référence ;</li>
     * <li>retourne les objets métier avec leur parent {@link TypeProduitJPA} ;</li>
     * <li>n'altère pas le stockage.</li>
     ...
     */
    @Tag(TAG_DAO_SOUS_TYPE_PRODUIT)
    @DisplayName(DN_FIND_ALL_BY_TYPE_PRODUIT_OK)
    @Test
    public void testFindAllByTypeProduitTrouve() throws Exception {
         ...
         * du parent TypeProduit "vêtement".
         *
         * Ce parent est celui des objets métier seedés :
         * - vêtement pour homme ;
         * - vêtement pour femme ;
         * - vêtement pour enfant.
         */
         ...
         * au moins un objet métier enfant.
         */
        final Long countEnfantsParent = this.jdbcTemplate.queryForObject(
                SELECT_COUNT_FROM_SOUS_TYPES_PRODUIT_WHERE_PARENT,
                Long.class,
                idParentStockage);

        assertThat(countEnfantsParent).isNotNull().isPositive();
        ...
        final List<Map<String, Object>> lignesStockage =
                this.jdbcTemplate.queryForList(
                        SELECT_SOUS_TYPES_AVEC_PARENT_WHERE_PARENT,
                        idParentStockage);

        assertThat(lignesStockage).isNotNull().isNotEmpty();
        assertThat(lignesStockage).hasSize(countEnfantsParent.intValue());
         ...
         * la méthode dérivée Spring Data doit rechercher les enfants
         * rattachés à ce parent.
         */
        final TypeProduitJPA parent =
                new TypeProduitJPA(idParentStockage, VETEMENT);

        /* ACT :
         * appelle directement le DAO, sans passer par le Gateway.
         */
        final List<SousTypeProduitJPA> resultats =
                this.sousTypeProduitDaoJPA.findAllByTypeProduit(parent);
     ...
     * <p>garantit que
     * {@link SousTypeProduitDaoJPA#findAllByTypeProduit(TypeProduitJPA)}
     * avec un parent existant sans enfant :</p>
     * <ul>
     * <li>reste cohérent avec l'absence de ligne enfant dans le stockage ;</li>
     * <li>retourne une liste non null ;</li>
     * <li>retourne une liste vide, conformément au comportement Spring Data
     * attendu pour cette signature liste ;</li>
     * <li>n'altère pas le stockage.</li>
     ...
     */
    @Tag(TAG_DAO_SOUS_TYPE_PRODUIT)
    @DisplayName(DN_FIND_ALL_BY_TYPE_PRODUIT_PARENT_SANS_ENFANT)
    @Test
    public void testFindAllByTypeProduitParentSansEnfant()
            throws Exception {
        ...
        /*
         * Retrouve directement dans le stockage l'identifiant
         * du parent TypeProduit "bazar".
         *
         * Ce parent est bien présent dans TYPES_PRODUIT,
         * mais aucun SousTypeProduit seedé ne lui est rattaché.
         */
        final Long idParentStockage = this.jdbcTemplate.queryForObject(
                SELECT_ID_FROM_TYPES_PRODUIT_WHERE_LIBELLE,
                Long.class,
        ...
        /*
         * Vérifie directement dans le stockage que ce parent
         * ne porte aucun objet métier enfant.
         */
        final Long countEnfantsParent = this.jdbcTemplate.queryForObject(
                SELECT_COUNT_FROM_SOUS_TYPES_PRODUIT_WHERE_PARENT,
                Long.class,
        ...
        assertThat(countEnfantsParent).isNotNull().isZero();

        /*
         * Prépare l'entity parent transmise au DAO.
         *
         * Le parent existe réellement dans le stockage,
         * mais il ne possède aucun enfant SousTypeProduit.
         */
        final TypeProduitJPA parent =
                new TypeProduitJPA(idParentStockage, BAZAR);

        /* ACT :
         * appelle directement le DAO avec un parent existant sans enfant.
         */
        final List<SousTypeProduitJPA> resultats =
                this.sousTypeProduitDaoJPA.findAllByTypeProduit(parent);
...
} // FIN DE LA CLASSE SousTypeProduitDaoJPATest.---------------------------
