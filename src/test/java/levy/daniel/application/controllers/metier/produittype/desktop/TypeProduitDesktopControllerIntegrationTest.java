 ...
 * {@link TypeProduitIController}, avec preuve BD directe.</li>
 * </ul>
 * </div>
 * 
 * <div>
...
public class TypeProduitDesktopControllerIntegrationTest {
	...
	public void testFindByLibelleAbsentAvecPreuveBd() throws Exception {
		...
		/* ===================== ARRANGE ===================== */
		final long baseline = this.compterTousLesTypeProduitEnBase();
		final String libelle = "IT-CTRL-DESKTOP-INEXISTANT";
	...
	public void testFindByLibelleRapideAbsentAvecPreuveBd() throws Exception {
		...
		/* ===================== ARRANGE ===================== */
		final long baseline = this.compterTousLesTypeProduitEnBase();
		final String contenu = "IT-CTRL-DESKTOP-RAPIDE-INEXISTANT";
	...
	public void testFindByDTOAbsentAvecPreuveBd() throws Exception {
		...
		/* ===================== ARRANGE ===================== */
		final long baseline = this.compterTousLesTypeProduitEnBase();
		final String libelle = "IT-CTRL-DESKTOP-DTO-INEXISTANT";
