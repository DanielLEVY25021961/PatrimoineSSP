 ...
 * pour l'Entity JPA <span style="font-weight:bold;">TypeProduitJPA</span>.
 * </p>
 *
 * <p>
...
public interface TypeProduitDaoJPA extends 
					JpaRepository<TypeProduitJPA, Long> {
	 ...
	 * </div>
	 *
	 * @return List&lt;TypeProduitJPA&gt; : liste complète (éventuellement vide).
	 */
	@Override
