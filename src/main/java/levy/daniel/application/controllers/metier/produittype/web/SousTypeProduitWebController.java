 ...
 * CLASSE SousTypeProduitWebController.java :
 * </p>
 *
...
public class SousTypeProduitWebController 
	...
	private static final Logger LOG = LogManager
			.getLogger(SousTypeProduitWebController.class);
	 ...
	 */
	public SousTypeProduitWebController(
	...
	public List<SousTypeProduitDTO.OutputDTO> rechercherTous() throws Exception {
	 ...
	 */
	@Override
	@GetMapping("/libellerapide")
	public List<OutputDTO> findByLibelleRapide(
			@RequestParam(value = "contenu", required = false)
	...
	public OutputDTO findById(
			@RequestParam(value = "id", required = false) final Long pId)
					throws Exception {
