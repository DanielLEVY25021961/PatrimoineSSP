...
public class TypeProduitWebController implements TypeProduitIController {
	...
	*/
	...
	public OutputDTO findByDTO(
		...
		/*
		 * Si pInputDTO == null :
		 * émet un message utilisateur MESSAGE_FIND_BY_DTO_VUE_NULL
		 * + retourne null.
		 */
		if (pInputDTO == null) {
		...
		try {
			 ...
			 * n'est pas contrôlé localement ici par le CONTROLLER.
			 * Il est délégué au SERVICE UC,
	...
	public OutputDTO findById(
		...
		/*
		 * Si pId == null :
		 * émet un message utilisateur MESSAGE_FIND_BY_ID_VUE_NULL
		 * + retourne null.
		 */
		if (pId == null) {
