...
public interface SousTypeProduitIController {
	 ...
	 * <p style="font-weight:bold;">
	 * Retourne à la VUE
	 * la liste exhaustive des {@link SousTypeProduit}
	 ...
	 * au SERVICE UC
	 * via {@link SousTypeProduitICuService#rechercherTous()}.</li>
	 ...
	 * <ul>
	 * <li>recevoir depuis la VUE
	 * un libellé exact de {@link SousTypeProduit} ;</li>
	 ...
	 * {@link SousTypeProduitICuService#findByLibelle(String)} ;</li>
	 * <li>retourner à la VUE
	 * la liste des {@link SousTypeProduitDTO.OutputDTO}
	 ...
	 * @return List&lt;SousTypeProduitDTO.OutputDTO&gt; :
	 * la liste des SousTypeProduit trouvés retournée à la couche VUES ;
	 * peut être {@code null}
	 * si le CONTROLLER bloque la saisie
	 * avant délégation ;
	 ...
	 */
	List<SousTypeProduitDTO.OutputDTO> findByLibelle(String pLibelle)
			throws Exception;
	 ...
	 * {@link SousTypeProduitICuService#findByLibelleRapide(String)} ;</li>
	 * <li>retourner à la VUE
	 * la liste des {@link SousTypeProduitDTO.OutputDTO}
	 * fournie par le SERVICE UC
	 * ou {@code null}
	 ...
	 * {@link SousTypeProduitICuService#findByDTO(SousTypeProduitDTO.InputDTO)} ;</li>
	 * <li>retourner à la VUE
	 * le {@link SousTypeProduitDTO.OutputDTO}
	 * fourni par le SERVICE UC
	 * ou {@code null}
	 ...
	 * via
	 * {@link SousTypeProduitICuService#findByDTO(SousTypeProduitDTO.InputDTO)}.</li>
	 * <li>Le comportement porté par le contenu métier
	 * de l'InputDTO
	 * (parent blank, parent absent, enfant introuvable,
	 * succès, erreur technique)
	 ...
	 * un {@link SousTypeProduit}
	 * à partir d'un {@link SousTypeProduitDTO.InputDTO}
	 * transmis.
	 * </p>
	 *
	 * <p>INTENTION DE CONTROLLER (scénario nominal) :</p>
	 ...
	 * {@link SousTypeProduitICuService#delete(SousTypeProduitDTO.InputDTO)} ;</li>
	 ...
	 * au SERVICE UC
	 * via {@link SousTypeProduitICuService#count()}.</li>
	 * <li>En cas de succès, la méthode récupère
	 * le message utilisateur courant du SERVICE UC
