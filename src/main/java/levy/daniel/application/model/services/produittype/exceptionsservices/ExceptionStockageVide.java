 ...
 * 
 * <div>
 * <p style="font-weight:bold;">CLASSE ExceptionStockageVide.java :</p>
 * </div>
 *
 * @author Daniel Lévy
 * @version 1.0
 * @since 16 janv. 2026
 */
public class ExceptionStockageVide extends Exception {
	...
	private static final Logger LOG = LogManager
			.getLogger(ExceptionStockageVide.class);
	...
	*/
	 ...
	 */
	public ExceptionStockageVide(final String pMessage) {
		super(pMessage);
	}
