 ...
 * INTERFACE SousTypeProduitGatewayIService.java :
 * </p>
 *
 * <p>
 ...
 * pour l'objet métier enfant de {@link TypeProduit} :
 ...
 * {@code SousTypeProduitCUService} pour :
 * </p>
 * <ul>
 * <li>créer / modifier une Entity via {@link #creer(SousTypeProduit)}</li>
 ...
 * <li>rechercher par objet métier via {@link #findByObjetMetier(SousTypeProduit)}</li>
 ...
 * <li>lister toutes les Entities par parent via {@link #findAllByParent(TypeProduit)}</li>
 * <li>rechercher par ID via {@link #findById(Long)}</li>
 * <li>modifier via {@link #update(SousTypeProduit)}</li>
 * <li>supprimer via {@link #delete(SousTypeProduit)}</li>
 ...
 * <div>
 * <p>
 * {@code safeMessage(e)} désigne une fonction utilitaire
 * utilisée par les implémentations (ADAPTERS) du présent PORT
 * pour garantir des messages d'exception jamais {@code null}.
 * </p>
 * </div>
 *
 * @author Daniel Lévy
 ...
 */
public interface SousTypeProduitGatewayIService {
	...
	/**
	 * <div>
	 * <p style="font-weight:bold;">Sauvegarde un {@link SousTypeProduit}
	 ...
	 * (scénario nominal) :</p>
	 * <ul>
	 * <li>Vérifier la persistance du parent {@link TypeProduit}.</li>
	 ...
	 * <li>Si {@code pObject.getTypeProduit() == null} :
	 ...
	 * + {@code pObject.getTypeProduit().getTypeProduit()}.</li>
	 ...
	 * le Sous-Type de Produit à stocker.
	 * @return SousTypeProduit :
	 * le Sous-Type de Produit sauvegardé dans le stockage.
	 *
	 ...
	 * <div>
	 * <p style="font-weight:bold;">
	 * Retourne tous les {@link SousTypeProduit}
	 ...
	 * Liste des SousTypeProduit dans le stockage. Jamais {@code null}.
	 *
	 * @throws ExceptionTechniqueGateway
	 ...
	 * requête pagination.
	 * @return {@link ResultatPage}&lt;SousTypeProduit&gt; :
	 ...
	 * <div>
	 * <p style="font-weight:bold;">
	 * Recherche un {@link SousTypeProduit} persistant à partir
	 * d'un objet métier.</p>
	 * </div>
	 *
	 * <div>
	 ...
	 * (scénario nominal) :</p>
	 * <ul>
	 * <li>Déléguer au DAO la récupération de la collection d'Entities
	 * du parent, puis rechercher dans cette collection, par libellé,
	 ...
	 * @throws ExceptionAppliParentNull
	 * si {@code pObject.getTypeProduit() == null}.
	 * @throws ExceptionTechniqueGatewayNonPersistent
	 ...
	 * @throws Exception toute autre exception levée par l'implémentation.
	 */
	SousTypeProduit findByObjetMetier(SousTypeProduit pObject)
			throws Exception;
	 ...
	 * {@link SousTypeProduit}
	 * via un libellé exact (sans tenir compte de la casse).</p>
	 * <ul>
	 ...
	 * les Entities JPA trouvées en objets métier.</li>
	 ...
	 * <li>Si {@code DAO.findBySousTypeProduitIgnoreCase(pLibelle)}
	 * retourne {@code null} :
	 * jette une {@link ExceptionTechniqueGateway}
	 * avec un message {@link #ERREUR_TECHNIQUE_KO_STOCKAGE}.</li>
	 ...
	 * @throws ExceptionTechniqueGateway
	 * si {@code DAO.findBySousTypeProduitIgnoreCase(pLibelle)}
	 * retourne {@code null}
	 * ou si une erreur technique survient lors de l'accès au stockage.
	 * @throws Exception toute autre exception levée par l'implémentation.
	 */
	 ...
	 * <div>
	 * <p style="font-weight:bold;">
	 * Retourne la List&lt;SousTypeProduit&gt; des {@link SousTypeProduit}
	 ...
	 * @throws Exception toute autre exception levée par l'implémentation.
	 */
	List<SousTypeProduit> findByLibelleRapide(String pContenu)
			throws Exception;
	 ...
	 * <p style="font-weight:bold;">
	 * Retourne tous les {@link SousTypeProduit}
	 * rattachés au {@link TypeProduit} pParent parent.
	 * </p>
	 * </div>
	 *
	 * <div>
	 ...
	 * + {@code pParent.getTypeProduit()}.</li>
	 * <li>Si le parent n'existe pas dans le stockage :
	 * jette une {@link ExceptionTechniqueGatewayNonPersistent}
	 * avec un message
	 * {@link #MESSAGE_FINDALLBYPARENT_KO_PARENT_NON_PERSISTENT}
	 * + {@code pParent.getTypeProduit()}.</li>
	 * <li>Si {@code DAO.findAllByTypeProduit(...)} retourne {@code null} :
	 * jette une {@link ExceptionTechniqueGateway}
	 * avec un message {@link #ERREUR_TECHNIQUE_KO_STOCKAGE}.</li>
	 * <li>Si aucun résultat :
	 * retourne une liste vide. Pas d'Exception.</li>
	 ...
	 * </div>
	 *
	 * @param pParent : TypeProduit : parent.
	 * @return List&lt;SousTypeProduit&gt; :
	 ...
	 * @throws Exception toute autre exception levée par l'implémentation.
	 */
	List<SousTypeProduit> findAllByParent(TypeProduit pParent)
			throws Exception;
	 ...
	 * <li>Si {@code DAO.findById(pId)} retourne {@code null} :
	 * jette une {@link ExceptionTechniqueGateway}
	 * avec un message {@link #ERREUR_TECHNIQUE_KO_STOCKAGE}.</li>
	 * <li>Si le {@link SousTypeProduit} n'est pas trouvé :
	 * retourne {@code null}. Pas d'Exception.</li>
	 * <li>Si une erreur technique survient lors de l'accès au stockage :
	 * jette une {@link ExceptionTechniqueGateway}
	 * avec un message {@link #ERREUR_TECHNIQUE_STOCKAGE}
	 ...
	 * <div>
	 * <p style="font-weight:bold;">
	 * Modifie un {@link SousTypeProduit}
	 ...
	 * + {@code pObject.getSousTypeProduit()}.</li>
	 ...
	 * avec un message {@link #MESSAGE_UPDATE_KO_PARENT_NON_PERSISTENT}
	 * + {@code pObject.getTypeProduit().getTypeProduit()}.</li>
	 * <li>Si {@code DAO.findById(...)} retourne {@code null} :
	 * jette une {@link ExceptionTechniqueGateway}
	 * avec un message {@link #ERREUR_TECHNIQUE_KO_STOCKAGE}.</li>
	 * <li>Si {@code DAO.save(...)} retourne {@code null} :
	 * jette une {@link ExceptionTechniqueGateway}
	...
	/**
	 * <div>
	 * <p style="font-weight:bold;">Détruit un {@link SousTypeProduit}
	 * déjà existant dans le stockage.</p>
	 * </div>
	 *
	 * <div>
	 ...
	 * <li>Si {@code pObject.getIdSousTypeProduit() == null} :
	 * jette une {@link ExceptionAppliParamNonPersistent}
	 ...
	 * @throws ExceptionAppliParamNull si {@code pObject == null}.
	 * @throws ExceptionAppliParamNonPersistent
	 * si {@code pObject.getIdSousTypeProduit() == null}.
	 * @throws ExceptionTechniqueGateway
	 * si une erreur technique survient lors de l'accès au stockage.
	 * @throws Exception toute autre exception levée par l'implémentation.
	 */
	 ...
	 * <div>
	 * <p style="font-weight:bold;">
	 * Compte le nombre de {@link SousTypeProduit}
	 * dans le stockage.</p>
	 * </div>
	 *
	 * <div>
