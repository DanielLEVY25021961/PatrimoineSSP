 ...
 * CLASSE ExceptionAppliLibelleBlank.java :</p>
 * <p>Exception levée lorsqu'un libellé est vide ou null.</p>
 * <p>Utilisée pour valider les entrées 
 ...
 * <ul>
 * <li>Validation d'un libellé :
 * <pre>
 * if (StringUtils.isBlank(libelle)) {
 *     throw new ExceptionAppliLibelleBlank("Le libellé est obligatoire.");
 * }
 * </pre>
 * </li>
 * <li>Gestion dans un contrôleur Spring :
 * <pre>
 * } catch (ExceptionAppliLibelleBlank e) {
 ...
 */
public class ExceptionAppliLibelleBlank extends Exception {
	...
	private static final Logger LOG = LogManager
			.getLogger(ExceptionAppliLibelleBlank.class);
	...
	* </div>
	*/
	public ExceptionAppliLibelleBlank() {
		this(null);
	 ...
	 */
	public ExceptionAppliLibelleBlank(final String pMessage) {
		super(pMessage);
	}
