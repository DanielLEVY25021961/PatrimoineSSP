 ...
 * 
 * <div>
 * <p style="font-weight:bold;">CLASSE ExceptionParametreBlank.java :</p>
 * </div>
 *
 * @author Daniel Lévy
 * @version 1.0
 * @since 16 janv. 2026
 */
public class ExceptionParametreBlank extends Exception {
	...
	private static final Logger LOG = LogManager
			.getLogger(ExceptionParametreBlank.class);
	...
	* </div>
	*/
	public ExceptionParametreBlank() {
		this(null);
	 ...
	 */
	public ExceptionParametreBlank(final String pMessage) {
		super(pMessage);
	}
